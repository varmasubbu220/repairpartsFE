...
<footer className="footer bg-black" >
      ...
      <div className="row gy-4 gy-lg-0 justify-content-xl-between">
        ...
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
          <div className="widget">
            ...
            <p className="mb-1">
              <a className="link-secondary text-decoration-none" href="tel:+917682692367">+91 9287361428</a>
            </p>
            <p className="mb-0">
              <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">demo@repairparts.com</a>
            </p>
          </div>
        </div>
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
  ...
  <div className="bg-black text-white py-4 py-md-5 py-xl-8 border-top border-light-subtle">
    <div className="container overflow-hidden">
      <div className="row gy-4 gy-md-0 align-items-md-center">
        <div className="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          <div className="credits text-secondary text-center text-md-start mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">RepairParts</a> with <span className="text-primary">&#9829;</span>
          </div>
        </div>
        <div className="col-xs-12 col-md-5 order-0 order-md-1">
          <div className="social-media-wrapper">
            <ul className="list-unstyled m-0 p-0 d-flex justify-content-center justify-content-md-end">
              ...
              <li classNameName="">
                <a href="#!" classNameName="link-dark link-opacity-75-hover">
